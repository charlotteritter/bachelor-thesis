...
put TestingFile2;
put n, put tol, put steprule, put FinalIter, put convergence, put r, put GapNaive, put ObjNaive, put lowerbound, put (lowerbound-min(upperbound,zupper))/min(upperbound,zupper), put TimeNaive, put lr_time put lambda put /;
